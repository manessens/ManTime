...
<div class="users form large-10 large-10bis medium-8 columns content">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->control('isProject',  ['type' => 'checkbox', 'label' => ['text'=>'Chef de projet', 'class' => 'text-primary checkboxU']]);
            echo $this->Form->control('isAdmin', ['type' => 'checkbox', 'label' => ['class' => 'text-danger checkboxU']]);
