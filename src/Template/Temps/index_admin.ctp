    ...
    <?= $this->Form->create() ?>
        <div class="block col-xs-12">
            ...
            <div class="controler right">
                <div><input type="week" data-target="index-admin" name="select-week" id="select-week" min="2018-W01" value="<?php echo $annee ?>-W<?php echo $semaine<10?'0'.$semaine:$semaine ; ?>" ></div>
                <div class="left">
